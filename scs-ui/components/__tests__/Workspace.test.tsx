...
test("authorized navigation and unavailable financial metrics are explicit", () => {
  render(<Workspace employee={{...employee,roles:["owner"],permissions:["manage_employees","manage_jobs","view_financials","view_technician_level"]}} jobs={[]} summary={{total_spend:{state:"not_available",value:null},average_payment_days:{state:"not_available",value:null}}} />);
