"""DEFENDmarkets benchmark demo (Demo A-D).
...
Usage:
    ...
    python tools/defend_markets_demo.py --demo a --demo b --demo c --demo d
"""
...
def main() -> None:
    ...
    parser.add_argument("--demo", action="append", choices=("a", "b", "c", "d"), required=True)
