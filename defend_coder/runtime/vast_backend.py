...
from defend_coder.runtime.launch import (
    coder_default_launch,
    coder_heavy_direct_launch,
    coder_resource_default,
)
...
from defend_coder.runtime.remote_vllm import CoderRemoteVllmBootstrap, CoderRemoteVllmError
from shared_platform.compute_types import LaunchSpec, ResourceProfile, VastInstance, VastOffer
...
from defend_coder.runtime.vast_diagnostics import (
    DirectEndpointProbe,
    DirectEndpointState,
...
class VastCoderBackend:
    ...
    def __post_init__(self) -> None:
        if self.profile is None:
            object.__setattr__(self, "profile", coder_resource_default())
        if self.launch is None:
            object.__setattr__(self, "launch", coder_default_launch())
